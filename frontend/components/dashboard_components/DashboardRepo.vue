<template>
  <div>
    <v-row class="mb-2"><v-btn @click="refreshRepo">Refresh Repo List</v-btn></v-row>
    <v-row>
        ...
        <v-card-action
          ><v-row class="d-flex align-content-center mx-5">
            ...
            <v-col class="d-flex justify-end mt-2">
              <v-btn color="red">SELL</v-btn><v-btn>UNLIST</v-btn>
            </v-col>
          </v-row></v-card-action
        >
      </v-card>
...
export default class MyStore extends Vue {
  @Prop({ required: true }) readonly refreshRepo!: void
}
</script>
